...
from comfy_api.ldm.util import exists
import comfy_api.patcher_extension
import comfy_api.ops
ops = comfy_api.ops.disable_weight_init
...
class UNetModel(nn.Module):
    ...
    def forward(self, x, timesteps=None, context=None, y=None, control=None, transformer_options={}, **kwargs):
        return comfy_api.patcher_extension.WrapperExecutor.new_class_executor(
            self._forward,
            self,
            comfy_api.patcher_extension.get_all_wrappers(comfy_api.patcher_extension.WrappersMP.DIFFUSION_MODEL, transformer_options)
