...
import torch
import comfy_api.ldm.flux.layers
import comfy_api.ldm.modules.diffusionmodules.mmdit
...
from comfy_api.ldm.flux.layers import (
    DoubleStreamBlock,
    EmbedND,
    LastLayer,
    MLPEmbedder,
...
class HunyuanVideo(nn.Module):
    ...
    def __init__(self, image_model=None, final_layer=True, dtype=None, device=None, operations=None, **kwargs):
        ...
        self.img_in = comfy_api.ldm.modules.diffusionmodules.mmdit.PatchEmbed(None, self.patch_size, self.in_channels, self.hidden_size, conv3d=True, dtype=dtype, device=device, operations=operations)
